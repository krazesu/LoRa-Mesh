...
The repository contains two arduino codes (.INO) in C++: one for the sensor nodes and one for the gateway node, and a technical paper for capstone project requirement
